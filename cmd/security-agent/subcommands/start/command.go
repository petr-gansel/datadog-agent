...
func start(log log.Component, config config.Component, telemetry telemetry.Component,
	...
	err := RunAgent(ctx, log, config, telemetry, wmeta, forwarder, params.pidfilePath)
...
func RunAgent(ctx context.Context, log log.Component, config config.Component, telemetry telemetry.Component, wmeta workloadmeta.Component, forwarder defaultforwarder.Component, pidfilePath string) (err error) {
